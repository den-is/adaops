# Compact address' all UTXOs into one UTXO
# UTXOs have ADA only
#
# python 3.13.1
# cardano-node 10.1.4
...
def transaction(
    ...
    if submit_success:
        ...
        #
        # during migration/compaction you have to check dst_addr for new transaction instead of src_addr
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = Path("/root/workspace/scripts/output/tx-compact-utxo")
    try:
    ...
    # bech32 address which has multiple UTXOs
